...
class F110_YOLO(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 256, kernel_size = 3, padding = 1, stride = 2)
        self.batchnorm1 = nn.BatchNorm2d(256)
        self.relu1 = nn.ReLU(inplace = True)

        self.conv2 = nn.Conv2d(256, 256, kernel_size = 3, padding = 1, stride = 2)
        ...
        self.conv4 = nn.Conv2d(512, 1024, kernel_size = 3, padding = 1, stride = 2)
        self.batchnorm4 = nn.BatchNorm2d(1024)
        self.relu4 = nn.ReLU(inplace = True)

        self.conv5 = nn.Conv2d(1024, 1024, kernel_size = 3, padding = 1, stride = 2)
        ...
        self.conv7 = nn.ConvTranspose2d(1024, 1024, kernel_size = 3, padding = 1, stride = 1)
        self.batchnorm7 = nn.BatchNorm2d(1024)
        self.relu7 = nn.ReLU(inplace = True)

        self.conv8 = nn.ConvTranspose2d(1024, 1024, kernel_size = 3, padding = 1, stride = 1)
        self.batchnorm8 = nn.BatchNorm2d(1024)
        self.relu8 = nn.ReLU(inplace = True)

        self.conv9 = nn.Conv2d(1024, 5, kernel_size = 1, padding = 0, stride = 1)
        self.relu9 = nn.ReLU()
